...
<script lang='ts'>
  ...
  // 引入copy组件，用来做粘性布局
  import AssortBarCopy from '@/main/home/recommend/AssortBarCopy.vue'
  ...
  export default {
    ...
    setup(props, context) {
      ...
      onMounted(() => {
        ...
        setInterval(() => {
          if(store.state.scrollTop >= carBarOffsetTop) {
            catBar.style.position = 'absolute'
          }else {
            catBar.style.position = 'static'
          }
        }, 100)
